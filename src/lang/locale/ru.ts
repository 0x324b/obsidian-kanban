...
const lang: Partial<Lang> = {
  ...
  "Board view": "Режим доски",
  "Move dates to card footer": "Переместить даты в нижний колонтитул карточки",
  "When toggled, dates will be displayed in the card's footer instead of the card's body.": "Если включено, даты будут отображаться в нижнем колонтитуле карточки, а не в ее теле.",
  "Move tags to card footer": "Переместить метки в нижний колонтитул карточки",
  "When toggled, tags will be displayed in the card's footer instead of the card's body.": "Если включено, метки будут отображаться в нижнем колонтитуле карточки, а не в ее теле.",
  "Move task data to card footer": "Переместить данные задач в нижний колонтитул карточки",
  "When toggled, task data (from the Tasks plugin) will be displayed in the card's footer instead of the card's body.": "Если включено, данные задач (из плагина Tasks) будут отображаться в нижнем колонтитуле карточки, а не в ее теле.",
  "Inline metadata position": "Позиция встроенных метаданных",
  "Controls where the inline metadata (from the Dataview plugin) will be displayed.": "Управляет отображением встроенных метаданных (из плагина Dataview).",
  ...
  "Search Kanban Board": "Поиск по Kanban-доске",
